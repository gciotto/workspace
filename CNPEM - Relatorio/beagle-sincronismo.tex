...
\FloatBarrier
	...
	\centering
		...
		\begin{subfigure}{.5\textwidth}
		  \centering
		  \includegraphics[scale=0.65]{image/thread_int}
		...
		\begin{subfigure}{.5\textwidth}
		  \centering
		  \includegraphics[scale=0.65]{image/thread_proc}
...
um função tratadora com \path{request_irq}. Entretanto, ao invés de enviarmos o
parâmetro \path{IRQF_TIMER} para este último, passamos
\path{IRQF_TRIGGER_RISING}, que detectará as interrupções na borda de subida.
