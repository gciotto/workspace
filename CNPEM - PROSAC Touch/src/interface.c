...
void sendCommand(uint8_t* buffer, uint16_t length ) {
	...
	int ret;
	ret = write(socket_in, buffer, length);
...
void draw_LOCON(void* board) {
	...
	BSP_LCD_DisplayStringAt(55, 45, aBoard->board.module.name, LEFT_MODE);
...
void print_new_analog_in() {
	...
	BSP_LCD_DisplayStringAt(320, 150, buffer, LEFT_MODE);

	xSemaphoreGive(mutex_drawer);

}

void print_new_digital_in() {
	...
	BSP_LCD_DisplayStringAt(320, 180, buffer, LEFT_MODE);
...
void decreaseDigitalIn (void* button) {
	...
	print_new_digital_in();
}

void increaseDigitalIn (void* button) {
...
void init_interface(void) {
	...
	buttons[BUTTON_E0].isEnabled = 0;
	buttons[BUTTON_E0].buttonPressedHandler = E0_pressed;
	...
	buttons[BUTTON_E1].buttonPressedHandler = E1_pressed;
	...
	buttons[BUTTON_01].buttonPressedHandler = Adjust_pressed;
	...
	buttons[BUTTON_05].isEnabled = 0;
	buttons[BUTTON_05].buttonPressedHandler = Confirm_pressed;
	...
	buttons[BUTTON_C8].isEnabled = 0;
	buttons[BUTTON_C8].buttonPressedHandler = C8_pressed;
	...
	buttons[BUTTON_C9].isEnabled = 0;
	buttons[BUTTON_C9].buttonPressedHandler = C9_pressed;
	...
	buttons[BUTTON_CB].isEnabled = 0;
	buttons[BUTTON_CB].buttonPressedHandler = CB_pressed;
	...
	buttons[BUTTON_CC].isEnabled = 0;
	buttons[BUTTON_CC].buttonPressedHandler = CC_pressed;
	...
	buttons_ramp_cycle[0].isEnabled = 0;
	buttons_ramp_cycle[0].buttonPressedHandler = decreaseRamp;
	...
	buttons_ramp_cycle[1].buttonPressedHandler = increaseRamp;
	...
	buttons_ramp_cycle[2].buttonPressedHandler = decreaseCycle;
	buttons_ramp_cycle[2].isEnabled = 0;
	...
	buttons_ramp_cycle[3].buttonPressedHandler = increaseCycle;
	...
	buttons_ramp_cycle[4].buttonPressedHandler = decreaseAnalogIn;
	...
	buttons_ramp_cycle[5].buttonPressedHandler = increaseAnalogIn;
	...
	buttons_ramp_cycle[6].buttonPressedHandler = decreaseDigitalIn;
	...
	buttons_ramp_cycle[7].buttonPressedHandler = increaseDigitalIn;
