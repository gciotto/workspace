...
/**
 * This class provides and implements all controls to communicate with a PROSAC host.
 * Each control provide a unique command that can be sent to PROSAC.
 *
...
public class Commands extends javax.swing.JPanel {
	...
	/**
	 * Contructs and enables all command buttons.
	 */
    public Commands() {
        initComponents();
        setNormal();
    ...
    /**
     * Sets the interface to enable only ABORT_CYCLE command. It is called when
     * a CYCLE_ENABLE was sent.
     */
    ...
    /**
     * Sets all buttons enabled as soon as the cycling curve was completed.
     */
    ...
    /**
     * Disables all buttons except SEND_BLOCK (0xC9) command button. It is called
     * after the user chooses INIT_RAMP (0xC8). 
     */
    ...
    /**
     * A ramp curve was successfully sent to PROSAC, thus all operations can be enabled,
     * except ABORT_CYCLE and ABORT_RAMP.
     */
    ...
    /**
     * Enables only ABORT_RAMP. It is called after a ENABLE_RAMP or ENABLE_CYCLIC_RAMP
     * commands are sent.
     */
    ...
    /**
     * A ramp has been completed, therefore all commands can be enabled.
     */
    ...
    /**
     * Normal state corresponds to all buttons enabled, except
     * the ones that abort cycling and ramping operations. 
     */
