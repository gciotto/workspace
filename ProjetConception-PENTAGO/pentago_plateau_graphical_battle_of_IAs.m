%%  FUNCTION pentago_plateau_graphical_battle_of_IAs:
...
%   It takes no parameters nor returns any values and simulates a game
%   between our AI against our teacher's AI.
...
%               eventdata is the data describing the event.
    function start_pressed(src,eventdata)
        ...
        if turn_random == 1
            ...
            set(textState, 'String', [ 'You are unlucky! Borgois AI begins! Uooo! Player Black has the turn']);
            ...
            set(textState, 'String', ['BORGOIS IA chose the circle at ( ' int2str(move(1)) ',' int2str(move(2)) ' ).']);
            
            set(textState, 'String', ['BORGOIS IA chose to turn quadrant no. ' int2str(quadrant) ' to the ' direction]);
            ...
            set(textState, 'String', [ 'You are lucky! Our AI begins! Player White has the turn']);
        ...
        if hasTurned == 1 && hasPlayed == 1
            ...
            elseif empty_Slots <= 0
                ...
                if turn == 'W'
                    ...
                    %[move quadrant direction score] = best_of_all_moves(state_matrix, 'W',0);
                    [eval move quadrant direction] = alpha_beta_search (state_matrix, empty_Slots, 2, -inf, +inf, 1, 'W');
