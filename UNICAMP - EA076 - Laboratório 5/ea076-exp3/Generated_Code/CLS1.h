...
**         IsHistoryCharacter           - bool CLS1_IsHistoryCharacter(byte ch, byte *cmdBuf, size_t cmdBufIdx, bool...
...
#define CLS1_DEFAULT_SERIAL  0 /* If set to 1, then the shell implements its own StdIO which is returned by CLS1_GetStdio(); */
...
bool CLS1_IsHistoryCharacter(byte ch, byte *cmdBuf, size_t cmdBufIdx, bool *isPrev);
/*
** ===================================================================
