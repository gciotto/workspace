...
** ===================================================================
*/
__attribute__((naked, no_instrument_function)) void WAIT3_Wait10Cycles(void)
{
...
** ===================================================================
*/
__attribute__((naked, no_instrument_function)) void WAIT3_Wait100Cycles(void)
{
...
void WAIT3_Waitms(uint16_t ms)
{
  ...
  msCycles = WAIT3_NofCyclesMs(1, WAIT3_INSTR_CLOCK_HZ);
  while(ms>0) {
    WAIT3_WaitLongCycles(msCycles);
    ms--;
  }
  /*lint -restore */
}
