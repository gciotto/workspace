...
em Energia e Materiais - CNPEM, Campinas, Brasil.}
 \\
  ...
  \begin{itemize}
    ...
    acelerador de partículas \textit{Sirius}. Instalação dos sistemas de controle (gerenciador de alarmes e
    arquivamento) de variáveis EPICS. Desenvolvimento de \textit{Kernel Module Drivers} para a BeagleBone Black.
